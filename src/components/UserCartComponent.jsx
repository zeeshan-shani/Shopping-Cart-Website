...
// Define PropTypes
UserCartComponent.propTypes = {
  cartCourses: PropTypes.array.isRequired,
  deleteCourseFromCartFunction: PropTypes.func.isRequired,
  totalAmountCalculationFunction: PropTypes.func.isRequired,
  setCartCourses: PropTypes.func.isRequired,
};
